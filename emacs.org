...
** About this file
This configuration is inspired by [[https://github.com/vidjuheffex/dotemacs][vidjuheffex's config]] and [[https://github.com/gilbertw1/emacs-literate-starter][gilbertw1's config]]. I've also taken inspiration from https://blog.sumtypeofway.com/posts/emacs-config.html.
...
Initially I defined the package sources here, but because we use org in the init.el, the built-in org version would always get used, rather than the version from orgmode.org. This caused issues with incompatible versions. To avoid that, all the package archive configuration has been moved to [[./init.el]]
