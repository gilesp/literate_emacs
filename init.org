...
** A function to set the framesize for streaming
 ...
 #+begin_src emacs-lisp
   ...
   (defvar gp/frame-streaming-width-720 188)
   (defvar gp/frame-streaming-height-720 48)
...
* uLisp
  I've installed [[http://www.ulisp.com/show?3KN3][uLisp]] on a Raspberry Pi Pico, and it should be possible to use inferior lisp mode to interacti with it.
